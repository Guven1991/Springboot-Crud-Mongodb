...
public class BookController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<BookResponse> findOneBook(@PathVariable String id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<BookResponse> updateBook(@RequestBody BookCreateRequest bookCreateRequest, @PathVariable String id) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<BookResponse> patchPrice(@RequestBody Map<Double, Double> update, @PathVariable String id) {
