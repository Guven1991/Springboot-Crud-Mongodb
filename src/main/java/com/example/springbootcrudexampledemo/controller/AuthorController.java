...
public class AuthorController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<AuthorGetByIdResponse> getAuthorById(@PathVariable String id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<AuthorResponse> updateBook(@RequestBody AuthorCreateRequest authorCreateRequest, @PathVariable String id) {
