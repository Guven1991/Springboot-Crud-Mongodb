...
public class BookServiceTest {
    ...
    public void createBook() {
        ...
        assertEquals(Optional.of("1"), Optional.ofNullable(bookDtoReturned.getId()));
    ...
    public void findOneBook() {
        ...
        BookDto bookDtoReturned = bookService.findOneBook("1");
    ...
    public void updateBook() {
        ...
        when(bookRepository.save(any())).thenReturn(book);
        BookDto bookDtoReturned = bookService.updateBook(bookDto, "1");
    ...
    public void patchPrice() {
        ...
        BookDto bookDtoReturned = bookService.patchPrice(update, "1");
        assertEquals(Optional.of(50.05), Optional.ofNullable(bookDtoReturned.getPrice()));
    ...
    public void getAllBooksByAuthorId() {
        ...
        List<BookDto> bookDtoList = bookService.getAllBooksByAuthorId("1");
        assertEquals(1, bookDtoList.size());
        assertEquals("guven", bookDtoList.get(0).getAuthor().getName());
    }
}
